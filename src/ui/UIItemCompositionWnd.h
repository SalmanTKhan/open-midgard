...
class UIItemCompositionWnd : public UIFrameWnd {
public:
    ...
    UIItemCompositionWnd();
    ~UIItemCompositionWnd() override = default;
    ...
    void SetCardItemIndex(unsigned int itemIndex);
    void SetEquipmentItemIndices(const std::vector<unsigned int>& itemIndices);
